...
Total direct hook call sites: 682

| Category | Files | Direct calls | Share |
|---|---|---:|---:|
| `REGISTRY_FEATURE` | 26 | 131 | 19.2 % |
| `INSTALLER_INFRASTRUCTURE` | 5 | 6 | 0.9 % |
| `API_BRIDGE` | 1 | 23 | 3.4 % |
| `LEGACY_EXCEPTION` | 32 | 522 | 76.5 % |
| `UNKNOWN` | 0 | 0 | 0.0 % |
...
| `tv/withaibuild/customiuizer/mods/Controls.kt` | 30 | 4 | 26 | `LEGACY_EXCEPTION` | mixed: typed=4, legacy=26 |
...
| `tv/withaibuild/customiuizer/mods/LauncherLayoutHooks.kt` | 28 | 1 | 27 | `LEGACY_EXCEPTION` | mixed: typed=1, legacy=27 |
| `tv/withaibuild/customiuizer/mods/LauncherSystemHooks.kt` | 15 | 3 | 12 | `LEGACY_EXCEPTION` | mixed: typed=3, legacy=12 |
| `tv/withaibuild/customiuizer/mods/SystemAudioAndVisualAndMoreHooks.kt` | 46 | 11 | 35 | `LEGACY_EXCEPTION` | mixed: typed=11, legacy=35 |
| `tv/withaibuild/customiuizer/mods/SystemAudioAndVolumeHooks.kt` | 5 | 3 | 2 | `LEGACY_EXCEPTION` | mixed: typed=3, legacy=2 |
...
| `tv/withaibuild/customiuizer/mods/Various.kt` | 59 | 1 | 58 | `LEGACY_EXCEPTION` | mixed: typed=1, legacy=58 |
