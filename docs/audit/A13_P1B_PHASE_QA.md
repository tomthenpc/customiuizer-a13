...
| P1B-4A | `ec05f5e948167742da6520cdf64b9fd32d360b3e` | `ecd6a95a247afee1cbe9a7cf1ff11e12f75c779a` | `53c83e4ae8a7b1d17a5bdd74d8fe95d69820d583` | `tasks/active/A13-PERF-P1B-4A-NOTIFICATION-MENU-HOT-PATH.md` | active | `QA_CONDITIONAL` | ROM 生命周期证据缺失：`ROM_LIFECYCLE_EVIDENCE_REQUIRED` | 获得可信 ROM evidence 后可升至 `QA_ACCEPTED_DEVICE_EVIDENCE_PENDING`；P0 真机基线待 QA-1/P6 收集 |
