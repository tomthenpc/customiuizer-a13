...
| P1B-4A | `ec05f5e948167742da6520cdf64b9fd32d360b3e` | `ecd6a95a247afee1cbe9a7cf1ff11e12f75c779a` | `929e5d0f315b6bd6a9ac4bbfec9de321b441e97d` | `tasks/active/A13-PERF-P1B-4A-NOTIFICATION-MENU-HOT-PATH.md` | active | `QA_REOPENED` | R2 关闭中：`PARTIAL_MENU_MUTATION`、`getMenuView` 异常安全、fatal 测试缺失、ROM 生命周期证据缺失、task/SHA/QA 治理错误、`git diff --check` trailing whitespace、correctness audit 与生产实现不一致 | ROM 生命周期证据待补；重新验证 `A13_HOOK_COST_MAP.*`；P0 真机基线待 QA-1/P6 收集；R2 完成后更新 closure SHA |
