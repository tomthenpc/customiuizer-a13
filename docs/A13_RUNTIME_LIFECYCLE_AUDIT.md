...
| MainModule per-process installer split | COMPLETED | `SystemServerInstaller`, `SystemUiInstaller`, `LauncherInstaller`, `PackageInstallerRouter` extracted from `MainModule` |
