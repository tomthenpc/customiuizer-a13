# A13 Professional Autonomous Stewardship v3
...
```text
docs/audit/A13_PROJECT_HEALTH_SNAPSHOT.md
docs/audit/A13_PROJECT_HEALTH_SNAPSHOT.json
```
...
- static config；
- compile/tests/lint；
- Fast + Full + assembleDebug；按现有 R8 audit 规则执行，不把 Debug 当正式 Release；
- artifact hash/size；
