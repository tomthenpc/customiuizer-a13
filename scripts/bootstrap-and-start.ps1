...
if ($HasStagedChanges) {
    git commit -m "chore: install final A13 autonomous control plane"
    if ($LASTEXITCODE -ne 0) {
...
Write-Host ""
Write-Host "CONTROL PLANE INSTALLED"
Write-Host "Repository: $RepoRoot"
Write-Host "Branch:     $ExpectedBranch"
Write-Host "HEAD:       $Head"
Write-Host ""
Write-Host "Next action for the Agent:"
