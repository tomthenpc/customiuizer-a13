...
description: Independently red-team one completed A13 atomic slice without modifying production code.
...
```text
@skills:a13-independent-review <base-sha> <head-sha> <task-slice-path>
```
