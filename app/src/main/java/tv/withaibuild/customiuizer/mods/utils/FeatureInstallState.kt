 ...
 *
 * One [FeatureInstallState] object lives per process in the module's class
 * loader. It is keyed by the stable integer [FeatureId.id] rather than by the
 * [FeatureId] object. This keeps lookups fast and avoids per-installer state
 * maps.
 */
