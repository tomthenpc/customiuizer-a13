...
object SystemLockScreenMoreHooks {
    ...
    private fun isTrustedWiFi(mContext: Context): Boolean {
        ...
        return name.monwf.customiuizer.utils.Helpers.containsStringPair(trustedNetworks, wifiManager.connectionInfo?.bssid)
    }
        ...
        try {
            ...
            for (device in cachedDevices) {
                ...
                if (mDevice.bondState == BluetoothDevice.BOND_BONDED &&
                    ...
                    name.monwf.customiuizer.utils.Helpers.containsStringPair(trustedDevices, mDevice.address)
                ) return true
            }
        } catch (t: Throwable) {
            XposedHelpers.log(t)
            ...
            override fun after(param: AfterHookCallback) {
                ...
                val fetchCachedDevicesReceiver = object : BroadcastReceiver() {
                    override fun onReceive(context: Context, intent: Intent) {
                        ...
                        updateIntent.setPackage(name.monwf.customiuizer.utils.Helpers.modulePkg)
