...
/**
 * Functional JVM shadow of {@link android.util.SparseIntArray} for unit tests.
 *
 ...
 * that assert on the state held by {@link ResourceHooks#fakes}.
 */
public class SparseIntArray implements Cloneable {
    ...
    private void growAndInsert(int key, int value, int insertion) {
        int n = mSize;
